...
import {
  formAdminStaticBeginnersSchema,
  updateAdminStaticBeginnersPage,
} from "./lib";

export const useFormStaticBeginners = ({
  form,
  id,
  setIsLoading,
}: {
  form: UseFormReturn<z.infer<typeof formAdminStaticBeginnersSchema>>;
  id?: string;
  ...
  const onSubmit = async (
    ...
    const response = await genericAPICallHandler(() =>
      updateAdminStaticBeginnersPage(payload),
    );
