...
const breadcrumbData = [BREADCRUMB.top, BREADCRUMB.employerPlan.base];

export default async function Page() {
  const STATIC_SLUG = "General-Employer-Action-Plan"; // This value is dependent form the seeded
    ...
    <>
      <BackgroundContainer className="bg-white">
        <MainBlock size="sm" className="lg:p-0">
          ...
          <PageHeader>一般事業主行動計画</PageHeader>
        </MainBlock>
      </BackgroundContainer>
