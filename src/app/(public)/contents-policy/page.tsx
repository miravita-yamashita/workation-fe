...
const breadcrumbData = [BREADCRUMB.top, BREADCRUMB.contentsPolicy.base];

export default async function Page() {
  const STATIC_SLUG = "Content-Creation-Policy"; // This value is dependent form the seeded
    ...
    <>
      <BackgroundContainer className="bg-white">
        <MainBlock size="sm" className="lg:p-0">
          ...
          <PageHeader>コンテンツ作成ポリシー</PageHeader>
        </MainBlock>
      </BackgroundContainer>
